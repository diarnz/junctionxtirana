  ...
  <main class="public-page auth">
    ...
    <section class="auth__card card fade-up">
      ...
      <p class="auth__subtitle">
        Sign in to book spaces and track your requests.
      </p>

      <form class="auth__form" @submit.prevent="handleLogin">
        <label class="field">
          <span class="field-label">Email</span>
          <input v-model="email" class="input" type="email" autocomplete="email" placeholder="you@company.com" />
        </label>
        ...
        <button type="button" class="button button-secondary button-block" :disabled="auth.loading" @click="handleGoogleLogin">
      ...
      <div class="auth__demo">
        ...
        <p>Staff demo for admin dashboard access. Clients should register or use Google sign-in.</p>
        <button type="button" class="button button-secondary button-block" @click="fillDemo('admin')">
          Use staff demo login
        </button>
      </div>

      <div class="auth__foot">
        <span>Need a client account?</span>
        <RouterLink to="/register" class="auth__foot-link">Register →</RouterLink>
      </div>
    </section>
  </main>
</template>
